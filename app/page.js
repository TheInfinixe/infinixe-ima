...
const STR = {
  es: {
    ...
    cta_body_a: "El siguiente paso es entender tu resultado: te explicamos qué significa tu nivel y saldrás con un ",
    ...
    book_btn: "Qué significa tu resultado →",
    book_sub: "El siguiente paso: entiende tu resultado en 3 minutos.",
    finish: "Finalizar",
  ...
  en: {
    ...
    send_body_a: "We'll send a summary of your assessment results to ",
    ...
    cta_body_a: "The next step is understanding your result: we'll explain what your level means, and you'll leave with an ",
    ...
    book_btn: "What your result means →",
    book_sub: "The next step: understand your result in 3 minutes.",
    finish: "Finish",
            ...
            <div style={{ ...cd, padding: "28px 24px", textAlign: "center", border: "1px solid rgba(105,240,174,0.25)", background: "rgba(105,240,174,0.04)" }}>
              ...
              <div style={{ ...cd, padding: "24px", textAlign: "left", border: "1px solid rgba(179,136,255,0.2)", background: "linear-gradient(135deg,rgba(179,136,255,0.06),rgba(0,229,255,0.04))" }}>
                ...
                <button style={{ ...b1, background: "linear-gradient(135deg,#B388FF,#7C4DFF)", width: "100%", fontSize: 16, padding: "16px 32px" }}
                  onClick={() => { const firstName = (user.name || "").trim().split(/\s+/)[0] || ""; window.location.href = `/vsl?lvl=${lvl.level}&n=${encodeURIComponent(firstName)}`; }}>
                  {t.book_btn}
                </button>
